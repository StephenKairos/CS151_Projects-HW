...
public class Tile extends JLabel {
	...
	private static final long serialVersionUID = -3236029604740439018L;
	
	private IconCreator iconSetter;
	 ...
	 * 
	 * @param image
	 *            BufferedImage subimage to be used for the tile
	 * @param solvedRow
	 *            The row this tile must be in to be solved
	 * @param solvedColumn
	 *            The column this tile must be in to be solved.
	 */
	...
	/**
	 * Returns the status of whether the tile is in the correct position or not.
	 * 
	 * @param row
	 *            The row the tile must be in to be solved.
	 * @param column
	 *            The column the tile must be in to be solved.
	 * @return true if the tile is in the correct position, false if not.
	 */
	...
	/**
	 * Sets up the icon image for the tile from the local BufferedImage upon
	 * instantiation.
	 */
	...
	/**
	 * This is our strategy method. There are currently two strategies that can
	 * be set here: CreateBlankIcon() and CreateTileIcon()
	 */
	 ...
	 * 
	 * @param iconSetter
	 *            a concrete implementation of the iconCreator class.
	 */
